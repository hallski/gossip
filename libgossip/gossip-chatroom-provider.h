...
typedef enum {
	...
	GOSSIP_JOIN_CHATROOM_NICK_IN_USE,
	GOSSIP_JOIN_CHATROOM_NEED_PASSWORD
} GossipJoinChatroomResult;

typedef void (*GossipJoinChatroomCb) (GossipChatroomProvider   *provider,
